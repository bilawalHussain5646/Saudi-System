...
class Search_By_category_without_sharafdgonly:
    def UploadFileOnGoogleDrive(self,file_path):
        ...
        SERVICE_ACCOUNT_FILE = 'Sharaf_Dg/creds/cred.json'
        creds = None
    ...
    def __init__(self):
        ...
        df = pd.read_excel("Sharaf_Dg/categories/search_by_category.xlsx")
        ...
        dataframe_final.to_excel(excel_writer = f"Sharaf_Dg/output/{datetime.today().date()}_search_by_category_without_sharafdgonly.xlsx")
        file_path = f"Sharaf_Dg/output/{datetime.today().date()}_search_by_category_without_sharafdgonly.xlsx"
