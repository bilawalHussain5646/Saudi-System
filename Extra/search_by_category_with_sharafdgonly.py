...
class Search_By_Category_with_sharafdgonly:
        ...
        while each_page<total_pages: 
            ...
            try:
                ...
                # get all elements with the tag "a"
                    ...
                    if (title.text.find('Samsung') != -1 or title.text.find("LG") != -1 or title.text.find("Dyson") != -1) and (title.text.find('TCL') == -1):
    ...
    def __init__(self):
        ...
        df = pd.read_excel("categories/search_by_category_with_sharafdg.xlsx")
        ...
        dataframe_final.to_excel(excel_writer = f"output/{datetime.today().date()}_search_by_category_with_sharafdgonly.xlsx")
        file_path = f"output/{datetime.today().date()}_search_by_category_with_sharafdgonly.xlsx"


        self.UploadFileOnGoogleDrive(file_path)


Search_By_Category_with_sharafdgonly()          ## To run the script 
